...
export default function Aleshinloye() {
               ...
               <section className="first-class xl:lg:w-[55%] mt-5">
                 ...
                 <div className="flex justify-between">
                    ...
                    <span>
                         ...
                         <p className="text-yellow-900 text-sm">Total of 3 Stores Found</p>
                       </span>

                       <span className="flex gap-1 mt-1 ml-3">
                       <PiShoppingCartFill className="text-yellow-900 text-lg"/>
                       <p className="font-semibold text-yellow-900">Funny's stores</p>
                       </span>
                       <p className="text-yellow-900 text-sm ml-3">Buy the best at moderate prices</p>
                       <span className="flex gap-1 mt-1 ml-3"> 
                         <FaBriefcase className="text-yellow-900 text-lg"/> 
                         <p className="text-sm font-bold text-yellow-900">Babies & Kiddies</p>
                       </span>
                    </div>
